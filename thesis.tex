...
\usepackage[acronym, toc, automake, nomain]{glossaries} % for glossaries
...
% \usepackage{layout} % for debugging the layout
...
\include{intro}
\include{01_ch_related}
\include{02_ch_problem}
\include{03_ch_overhead}
\include{04_ch_workflow}
\include{05_ch_design}
\include{06_ch_validation}
\include{07_ch_prompting}
\include{08_ch_input}
\include{09_ch_architecture}
\include{10_ch_evaluation}
\include{11_ch_issues}
\include{12_ch_future}
\include{conclusion}
